...
const ApplicationTypes = ({ listing, requiredFields, isNonRegulated }: ApplicationTypesProps) => {
      ...
      >
        {isNonRegulated ? (
          ...
          <>
            <Grid.Row columns={2}>
              <Grid.Cell>
                <FieldGroup
                  ...
                  type="radio"
                  register={register}
                  groupLabel="Is there an application?"
                  fieldLabelClassName={`${styles["label-option"]} seeds-m-bs-2`}
                  fields={[
                    {
                      ...yesNoRadioOptions[0],
                      id: "applicationChoiceYes",
                      defaultChecked:
                        listing?.digitalApplication === true || listing?.paperApplication === true,
                    },
                    {
                      ...yesNoRadioOptions[1],
                      id: "applicationChoiceNo",
                      defaultChecked:
            ...
            {applicationChoice === YesNoEnum.yes && (
              <>
                <Grid.Row columns={2}>
                  <Grid.Cell>
                    <FieldGroup
                      ...
                      type="radio"
                      register={register}
                      groupLabel="Is there a digital application?"
                      fieldLabelClassName={`${styles["label-option"]} seeds-m-bs-2`}
                      fields={[
                        {
                          ...yesNoRadioOptions[0],
                  ...
                  <Grid.Cell>
                    <FieldGroup
                      ...
                      type="radio"
                      register={register}
                      groupLabel="Is there a paper application?"
                      fieldLabelClassName={`${styles["label-option"]} seeds-m-bs-2`}
                      fields={[
                        {
                          ...yesNoRadioOptions[0],
                        ...
                        {methods.paper?.paperApplications?.length > 0 && (
                          <MinimalTable
                            ...
                            data={methods.paper.paperApplications.map((item) => ({
                              ...
                              language: {
                                content: item.language ? t(`languages.${item.language}`) : "",
                              },
                              actions: {
                                content: (
                                  <div className="flex">
        ...
        {!isNonRegulated && paperApplicationChoice === YesNoEnum.yes && (
          <Grid.Row columns={1}>
            <Grid.Cell>
              {methods.paper?.paperApplications?.length > 0 && (
                <MinimalTable
